...
public:
    ...
    bls12_381_Fq2 X__() const { return X; }
    bls12_381_Fq2 Y__() const { return Y; }
    bls12_381_Fq2 Z__() const { return Z; }
    ...
    static std::size_t ceil_size_in_bits() { return twist_field::size_in_bits() + 1; }
