...
public:
    ...
    bls12_381_Fq X__() const { return X; }
    bls12_381_Fq Y__() const { return Y; }
    bls12_381_Fq Z__() const { return Z; }
    ...
    static std::size_t ceil_size_in_bits() { return base_field::size_in_bits() + 1; }
