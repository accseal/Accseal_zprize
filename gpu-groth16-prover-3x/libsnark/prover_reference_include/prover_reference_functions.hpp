...
public:
  ...
  static void print_Fr(vector_Fr *scalar_start, size_t i);
  static void convert_Fr(vector_Fr *scalar_start, var *H_, size_t j);
  ...
  static field *input_r_from_data(uint64_t *input);
