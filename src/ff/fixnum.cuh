...
#ifdef MNT4753
static constexpr size_t ELT_LIMBS_Q = 12;
static constexpr size_t ELT_BYTES_Q = ELT_LIMBS_Q * sizeof(var);
static constexpr size_t BIG_WIDTH_Q = ELT_LIMBS_Q + 4; // = 16
...
static constexpr size_t ELT_LIMBS_R = 12;
static constexpr size_t ELT_BYTES_R = ELT_LIMBS_R * sizeof(var);
static constexpr size_t BIG_WIDTH_R = ELT_LIMBS_R + 4; // = 16
#endif

#ifdef ALT_BN128
static constexpr size_t ELT_LIMBS_Q = 4;
static constexpr size_t ELT_BYTES_Q = ELT_LIMBS_Q * sizeof(var);
static constexpr size_t BIG_WIDTH_Q = ELT_LIMBS_Q; // = 4
static const int MAX_THREADS = 1024;
